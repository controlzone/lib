#ifndef _ROS_iai_robosherlock_actions_SimplePerceiveObjectFeedback_h
#define _ROS_iai_robosherlock_actions_SimplePerceiveObjectFeedback_h
...
namespace iai_robosherlock_actions
{
  ...
  class SimplePerceiveObjectFeedback : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "iai_robosherlock_actions/SimplePerceiveObjectFeedback"; };

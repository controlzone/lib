#ifndef _ROS_nao_msgs_SetSpeechVocabularyGoal_h
#define _ROS_nao_msgs_SetSpeechVocabularyGoal_h
...
namespace nao_msgs
{
  ...
  class SetSpeechVocabularyGoal : public ros::Msg
  {
    ...
    const char * getType(){ return "nao_msgs/SetSpeechVocabularyGoal"; };

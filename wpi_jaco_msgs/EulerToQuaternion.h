#ifndef _ROS_SERVICE_EulerToQuaternion_h
#define _ROS_SERVICE_EulerToQuaternion_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char EULERTOQUATERNION[] = "wpi_jaco_msgs/EulerToQuaternion";

  class EulerToQuaternionRequest : public ros::Msg
  {
    public:
      float roll;
      float pitch;
    ...
    const char * getType(){ return EULERTOQUATERNION; };
    const char * getMD5(){ return "c66f4de7f99199dd8e863fffbef112ad"; };

  };

  class EulerToQuaternionResponse : public ros::Msg
  {
    public:

#ifndef _ROS_cob_object_detection_msgs_DetectObjectsFeedback_h
#define _ROS_cob_object_detection_msgs_DetectObjectsFeedback_h
...
namespace cob_object_detection_msgs
{
  ...
  class DetectObjectsFeedback : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "cob_object_detection_msgs/DetectObjectsFeedback"; };

#ifndef _ROS_cob_object_detection_msgs_AcquireObjectImageFeedback_h
#define _ROS_cob_object_detection_msgs_AcquireObjectImageFeedback_h
...
namespace cob_object_detection_msgs
{
  ...
  class AcquireObjectImageFeedback : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "cob_object_detection_msgs/AcquireObjectImageFeedback"; };

#ifndef _ROS_iai_kinematics_msgs_MultiDOFJointState_h
#define _ROS_iai_kinematics_msgs_MultiDOFJointState_h
...
namespace iai_kinematics_msgs
{
  ...
  class MultiDOFJointState : public ros::Msg
  {
    ...
    const char * getType(){ return "iai_kinematics_msgs/MultiDOFJointState"; };

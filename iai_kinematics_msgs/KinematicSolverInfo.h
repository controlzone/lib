#ifndef _ROS_iai_kinematics_msgs_KinematicSolverInfo_h
#define _ROS_iai_kinematics_msgs_KinematicSolverInfo_h
...
namespace iai_kinematics_msgs
{
  ...
  class KinematicSolverInfo : public ros::Msg
  {
    public:
      ...
      iai_kinematics_msgs::JointLimits st_limits;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      if(limits_lengthT > limits_length)
        this->limits = (iai_kinematics_msgs::JointLimits*)realloc(this->limits, limits_lengthT * sizeof(iai_kinematics_msgs::JointLimits));
      offset += 3;
      limits_length = limits_lengthT;
      for( uint8_t i = 0; i < limits_length; i++){
      offset += this->st_limits.deserialize(inbuffer + offset);
        memcpy( &(this->limits[i]), &(this->st_limits), sizeof(iai_kinematics_msgs::JointLimits));
      }
    ...
    const char * getType(){ return "iai_kinematics_msgs/KinematicSolverInfo"; };

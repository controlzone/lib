#ifndef _ROS_iai_kinematics_msgs_PositionIKRequest_h
#define _ROS_iai_kinematics_msgs_PositionIKRequest_h
...
namespace iai_kinematics_msgs
{
  ...
  class PositionIKRequest : public ros::Msg
  {
    ...
    const char * getType(){ return "iai_kinematics_msgs/PositionIKRequest"; };
